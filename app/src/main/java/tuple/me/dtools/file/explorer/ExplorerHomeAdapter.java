...
public class ExplorerHomeAdapter extends BaseFilesAdapter implements SectionTitleProvider {

    public ExplorerHomeAdapter(Context context) {
        super(context);
        dataSet = new SortedList<>(Item.class, new SortedListAdapterCallback<Item>(this) {
            ...
            public int compare(Item o1, Item o2) {
                if (o1 instanceof SystemFile && o2 instanceof SystemFile) {
                    return SystemFile.compare(((SystemFile) o1), ((SystemFile) o2), SystemFile.SORT_DATE);
                }
