...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(@NonNull Context context, int orientation, boolean showtopbottomdividers, boolean show) {
    ...
    @Override
    public void onDraw(Canvas c, @NonNull RecyclerView parent) {
        if(!show)return;
        if(mDivider!=null)
    ...
    @Override
    public void getItemOffsets(@Nullable Rect outRect, int itemPosition, RecyclerView parent) {
